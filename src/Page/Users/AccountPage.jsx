...
const AccountPage = () => {
  ...
  const loadUserDetails = async () => {
    try {
      const loadUserDetail = LoginService.getCurrentUser();
      setUserDetail(loadUserDetail);
                  ...
                  <Box sx={{ display: "flex" }}>
                    ...
                    <Box sx={{ ml: 2 }}>
                      ...
                      <Typography
                        ...
                        fontWeight="500"
                      >
                        {`${loginService.getCurrentUser().firstName} ${
                          loginService.getCurrentUser().lastName
                        }`}
                      </Typography>
                    </Box>
                  </Box>
                ...
                <CardContent>
                  ...
                  >
                    <Box sx={{ display: "flex", alignItems: "center" }}>
                      <FolderSpecialIcon
                        style={{ color: "#00ABF0", fontSize: "30px" }}
                      />
                      <Box sx={{ ml: 2 }}>
                        <Typography
                          fontFamily="poppins"
                  ...
                  <Divider
                    sx={{ borderColor: "#777", mb: 1, ml: -2, mr: -2 }}
                  />
                  ...
                  <Divider
                    sx={{ borderColor: "#777", mt: 1, ml: -2, mr: -2 }}
                  />
                  ...
                  <CardContent sx={{ m: 1 }}>
                    <Box>
                      {activeTab === "Profile Information" ? (
                        <PersonalInfoPage {...userPersonalInfoProps} />
                      ) : activeTab === "Manage Address" ? (
                        <AddressPage {...addressInfoProps} />
                      ) : (
                        <RatingAndReviewPage />
                      )}
                    </Box>
