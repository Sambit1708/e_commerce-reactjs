...
const CheckOutPage = () => {
  ...
  const handleOpenPlaceOrderStatus = () => {
    setOpenPlaceOrderStatus(true);
  };

  const handleClosePlaceOrderStatus = () => {
    setOpenPlaceOrderStatus(false);
  };
  ...
  const completeOrder = () => {
    ...
    handleOpenPlaceOrderStatus();
    completeOrderDB(data);
  };

  const onClickAddAddressStyle = (e) => {
    if (
      e.target.innerText === "Add Address" ||
      e.target.innerText === "ADD ADDRESS"
    ) {
    ...
    <Box sx={{ bgcolor: "#f5f5f5" }}>
      ...
      {allCartItems.length !== 0 ? (
        <Box sx={{ width: "1250px", ml: "auto", mr: "auto", pt: 12 }}>
          <Grid container spacing={2}>
            <Grid item xs={8}>
              <Card>
                <CardHeader
                  sx={{ bgcolor: delivertStepper === 0 && "#2874f0" }}
                  title={
                    <Box sx={{ display: "flex", alignItems: "center" }}>
                      <Box
                        sx={{
                          ...
                          borderRadius: "2px",
                          bgcolor: delivertStepper !== 0 ? "#d3d3d3" : "white",
                          p: "0px 5px",
                        }}
                      >
                        <Typography
                      ...
                      <Box sx={{ ml: 2 }}>
                        <Typography
                          ...
                          textTransform="uppercase"
                          sx={{
                            color: delivertStepper !== 0 ? "#2874f0" : "white",
                          }}
                          fontWeight="500"
                        >
                          Delivery Address
                      ...
                      <Box sx={{ ml: 1 }}>
                        <FaCheck
                          display={delivertStepper !== 0 ? "block" : "none"}
                          color="green"
                        />
                      </Box>
                    </Box>
                ...
                />
                {delivertStepper === 0 && allAddress.length !== 0 ? (
                  <CardContent>
                    {allAddress.length !== 0 && (
                      <FormControl>
                        <RadioGroup
                ...
                ) : allAddress.length === 0 && addressOption !== "empty" ? (
                  <Box
                    sx={{
                      width: "fit-content",
                      ml: "auto",
              ...
              {delivertStepper === 0 && (
                <Card sx={{ mt: 3, textAlign: "left" }}>
                  <Box component="form">
                    ...
                    <Box
                      id="add-address-section"
                      sx={{ m: "50px auto", width: "600px", display: "none" }}
                    >
                      <Box>
                        <Typography
                          textTransform="uppercase"
              ...
              <Card sx={{ mt: 3 }}>
                <CardHeader
                  sx={{ bgcolor: delivertStepper === 1 && "#2874f0" }}
                  title={
                    <Box sx={{ display: "flex", alignItems: "center" }}>
                      <Box
                        sx={{
                          border: "1px solid white",
                          borderRadius: "2px",
                          bgcolor: delivertStepper !== 1 ? "#d3d3d3" : "white",
                          p: "0px 5px",
                        }}
                      >
                        <Typography
                      ...
                      <Box sx={{ ml: 2 }}>
                        <Typography
                          ...
                          textTransform="uppercase"
                          sx={{
                            color: delivertStepper !== 1 ? "#2874f0" : "white",
                          }}
                          fontWeight="500"
                        >
                          Order Summary
                      ...
                      <Box sx={{ ml: 1 }}>
                        <FaCheck
                          display={delivertStepper > 1 ? "block" : "none"}
                          color="green"
                        />
                      </Box>
                    </Box>
                            ...
                            <Box sx={{ display: "flex" }}>
                              ...
                              <Box sx={{ ml: 3 }}>
                                ...
                                <Typography
                                  ...
                                  sx={{ color: "grey" }}
                                >
                                  Size: {item.productSize.size},&nbsp;color:{" "}
                                  {item.product.productDetails.color}
                                </Typography>
                                <Typography
                                  fontFamily="poppins"
                                  fontSize="13px"
                  ...
                  <CardContent>
                    ...
                    >
                      ...
                      >
                        ...
                        <b style={{ color: "black" }}>
                          {loginService.getCurrentUser().email}
                        </b>
                      </Typography>
              ...
              <Card sx={{ mb: 3 }}>
                <CardHeader
                  sx={{ bgcolor: delivertStepper === 2 && "#2874f0" }}
                  title={
                    <Box sx={{ display: "flex", alignItems: "center" }}>
                      <Box
                        sx={{
                          border: "1px solid white",
                          borderRadius: "2px",
                          bgcolor: delivertStepper !== 2 ? "#d3d3d3" : "white",
                          p: "0px 5px",
                        }}
                      >
                        <Typography
                      ...
                      <Box sx={{ ml: 2 }}>
                        <Typography
                          ...
                          textTransform="uppercase"
                          sx={{
                            color: delivertStepper !== 2 ? "#2874f0" : "white",
                          }}
                          fontWeight="500"
                        >
                          Payment Option
                      ...
                      <Box sx={{ ml: 1 }}>
                        <FaCheck
                          display={delivertStepper === 3 ? "block" : "none"}
                          color="green"
                        />
                      </Box>
                    </Box>
        ...
        >
          ...
          >
            <Box
              sx={{ display: "flex", height: "25px", justifyContent: "center" }}
            >
      ...
      <Backdrop
        ...
        onClick={handleClosePlaceOrderStatus}
      >
