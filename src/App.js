...
import AllOrdersPage from "./Page/Users/AllOrdersPage";
...
import OrderDetailPage from "./Page/Users/OrderDetailPage";
            ...
            <Route element={<UserProtectedRoutes />}>
              <Route path="u">
                ...
                <Route path="account">
                  ...
                  <Route path="orders">
                    <Route index element={<AllOrdersPage />}></Route>
                    <Route path="details" element={<OrderDetailPage />}></Route>
                  </Route>
                </Route>
              </Route>
            </Route>
